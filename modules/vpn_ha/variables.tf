variable "create_network" {
  description = "Set to true to create a new VPC and subnets."
  type        = bool
  default     = true
}
...
variable "main_subnet_cidr" {
  description = "The CIDR range for the main subnetwork (e.g., 10.42.0.0/20)."
  type        = string
}

variable "connector_subnet_cidr" {
  description = "The CIDR range for the connector subnetwork (e.g., 10.42.15.0/28)."
  type        = string
}
